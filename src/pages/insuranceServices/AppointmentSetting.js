            ...
            <div className="w-7/12 pr-4 relative">
              ...
              <div className="mt-7 ml-12">
                ...
                <p>
                  ...
                  to go out on to look at the bidding the policies. We normally
                  start calling back on these leads 3 months prior to the x-date
                  of the lead, or when the insurance policy renews for the
                  business. This enables us enough time to be able to set-up an
                  appointment for our client to meet with the business to quote
                  their insurance for them. This is the final phase of our
                  program where we deliver appointments to our clients.
                </p>
              </div>
            </div>
