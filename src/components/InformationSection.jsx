        ...
        <div className="border-r border-gray-300 absolute inset-0 top-6 bottom-6 "></div>
          <div className=" mt-7 ml-12 z-10">
            <p className=" text-gray-600 text-sm z-10">
              ...
              relationship with our clients so everybody wins in the end.
            </p>
            <p className="mt-4 text-gray-600 text-sm">
              At Signature, we do business to business calling to generate
              activity for all ranges of commercial, benefits and
              professional liability insurance. We can help tailor a program
              that will generate the results you need. Whether it’s a
              certain amount of appointments per month, return on
              investment, or based on your budget. We help our customers
              reach their business objectives by using an experienced staff
              of account representatives who are knowledgeable in the
              commercial insurance industry. Our experienced reps can focus
              on any type of company size, industry, and geographic location
              to get you in front of interested qualified prospects. We feel
              that communication and service are the keys to a successful
              prospecting program. You deal directly with the account rep
              that sets your appointments’. That way there will be no
              confusion when you have questions about your program. Dealing
              directly with our rep, you can get quick answers on activity,
              appointments, and scheduling conflicts. No more having to wait
              for management to get back to you and answer these simple
              questions.
            </p>
            ...
            <h2 className="mt-4 text-sky-600 font-bold">
              Why sink your whole investment into a program that hasn't
              provided any results yet?
            </h2>
            <p className="mt-4 text-gray-600 text-sm">
              We can base your programs on the budget you have today. We
              offer our appointments on a, “Pay-Per Appointment”, basis. You
              only pay for the appointments you go out on. No more having to
            ...
            <p className="mt-4 text-gray-600 text-sm z-15">
              ...
              <a
                href="mailto:sales@signaturemktg.net"
            ...
            <p className="mt-4 text-gray-600 mb-20 text-sm">
              **Privacy Policy: No mobile information will be shared with
